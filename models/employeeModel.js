...
const employeSchema = new mongoose.Schema(
  {
    ...
    email: {
      ...
      //     // Check uniqueness only if email is provided and not an empty string
      //     if (typeof value === "string" && value.trim() !== "") {
      //       const user = await EmployeModel.findOne({ email: value });
      //       return !user; // Return true if no user with the given email is found
      //     }
      //     return true; // Allow empty string or other non-string values
      //   },
